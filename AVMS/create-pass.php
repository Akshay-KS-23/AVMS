...
$pno=mt_rand(10000000,99999999);
 $query=mysqli_query($con,"insert into tblvisitorpass(passnumber,VisitorName,MobileNumber,Address,Apartment,fromDate,toDate) value('$pno','$visname','$mobnumber','$add','$apart','$fdate','$tdate')");
